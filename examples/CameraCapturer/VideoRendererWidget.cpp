...
QSize VideoRendererWidget::minimumSizeHint() const
{
    return QSize(50, 50);
}

QSize VideoRendererWidget::sizeHint() const
{
    return size();
}

void VideoRendererWidget::setFrameSize(const QSize &frameSize)
{
...
const QSize& VideoRendererWidget::frameSize()
{
    return m_frameSize;
}

void VideoRendererWidget::updateTextures(const quint8 *dataY, const quint8 *dataU, const quint8 *dataV, quint32 linesizeY, quint32 linesizeU, quint32 linesizeV)
{
    if (m_textureInited) {
...
void VideoRendererWidget::resizeGL(int width, int height)
{
    glViewport(0, 0, width, height);
    repaint();
}

void VideoRendererWidget::initShader()
{
...
void VideoRendererWidget::initTextures()
{
    // 创建纹理
...
void VideoRendererWidget::deInitTextures()
{
...
void VideoRendererWidget::updateTexture(GLuint texture, quint32 textureType, const quint8 *pixels, quint32 stride)
{
    if (!pixels)
        return;
